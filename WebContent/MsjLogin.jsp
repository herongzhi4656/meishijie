...
<body>
    ...
    <div class="login_style">
        ...
        <a class="link register" href="MsjRegister.jsp">注册</a>
    ...
    <div class="n1_loginbox_w" id="msj_loginbox"  >
        <form method="post"  action="login1">
            ...
            <div class="n1_loginitem">
                <input id="usertext" class="text" type="text" value="" name="username" placeholder="请输入手机号/邮箱/昵称">
            </div>
            <div class="n1_loginitem">
                <input id="userpassword" type="password" class="password" name="password" placeholder="请输入密码">
            </div>
            ...
            <div class="n1_loginitem" style="text-align:center">
                <input class="submit" type="submit" value="登录" onclick="onchange()">
                
            </div>
            <span id="loginerror" style="display:none">用户名或密码错误!</span>
            <span id="loginempty" style="display:none">用户名或密码不能为空!</span>
        </form>
    </div>
    <div class="n1_more_zc" id="n1_more_zc" style="display:none">
      <div class="n1_table">
          <a id="zc_phone" href="javascript:void(0)">手机注册</a>
          |
    ...
    <div class="n1_loginbox_www">
        <div class="n1_loginbox_ww" style="margin-left:0px">
            <div class="n1_loginbox_w" style="float:left;">
                <form id="n1_phone_submit_btn_form" class="register_form_pm">
                    <div class="n1_loginitem">
                    ...
                    <div class="n1_loginitem">
                        <input id="mobile_code" class="text forcheck pyzm_forcheck"
                               type="text" passcheck="0" placeholder="请输入验证码" style="width:150px">
                    ...
                    <div class="n1_loginitem">
                        <label>
                            <input id="mobile_check" class="checkbox" type="checkbox" checked="1">
            ...
            <div class="n1_loginbox_w" style="float:left">
                <form id="n1_emial_submit_btn_form" class="register_form_email" method="POST">
                    <div class="n1_loginitem">
...
<!-- 
    <c:if test="${user.userId=='-1'||user.userId=='-2'}">
...
<script type="text/javascript" src="js/msj_login.js"></script>
</body>
